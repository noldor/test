    ...
    */
    ...
    'custom' => [
        'name' => [
            ...
            'max' => 'Поле "название" не должно быть больше 255 символов',
        ],
        'source' => [
            'required' => 'Поле "исходный текст" обязательно для заполнения',
            'max' => 'Поле "исходный текст" не должно быть больше 4 294 967 295 символов'
        ]
    ],
